...
public class MooseEntityModel extends EntityModel<MooseEntityRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
		...
		.uv(1, 21).cuboid(-6.0F, -5.0F, -2.0F, 1.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.origin(-2.0F, 0.0F, 1.0F));
		...
		.uv(1, 21).cuboid(-4.0F, -6.0F, -2.0F, 1.0F, 2.0F, 2.0F, new Dilation(0.0F))
		.uv(1, 21).cuboid(-2.0F, -5.0F, -2.0F, 1.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.origin(9.0F, 0.0F, 1.0F));
