...
public class CanadaModItemTagGenerator extends ItemTagProvider {
	...
	protected void configure(WrapperLookup wrapperLookup) {
		...
		this.getOrCreateTagBuilder(ItemTags.HEAD_ARMOR).add(CanadaItems.BEAVER_HELMET);
		this.getOrCreateTagBuilder(ItemTags.HEAD_ARMOR_ENCHANTABLE).add(CanadaItems.BEAVER_HELMET);
	}
}