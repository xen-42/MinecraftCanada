...
public class moose extends EntityModel<Entity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		.uv(21, 14).cuboid(-6.0F, -10.924F, -2.8682F, 1.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-5.0F, 0.0F, 1.0F));
		...
		.uv(28, 23).cuboid(-2.0F, -10.924F, -2.8682F, 1.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(12.0F, 0.0F, 1.0F));
